...
module.exports = {
  ...
  data: new SlashCommandBuilder().setName('history').setDescription("Tells you how long you've been a member of the server. Not for use in DMs.").setDMPermission(false),
